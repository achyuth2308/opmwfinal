...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Hi <?php echo e($application->applicant_name); ?>, we've received your application and our team will review it
                shortly.</p>
            <div class="divider"></div>
            <div class="detail-row"><span class="detail-label">Role</span><span
                    class="detail-value"><?php echo e($application->role); ?></span></div>
            <div class="detail-row"><span class="detail-label">Location</span><span
                    class="detail-value"><?php echo e($application->location); ?></span></div>
            <div class="detail-row"><span class="detail-label">Status</span><span class="detail-value"><span
                        class="badge"><?php echo e($application->status); ?></span></span></div>
            <div class="divider"></div>
...
</html><?php /**PATH D:\OPMW_One Place Multi Work\opmwfinal\opmw-backend\resources\views/emails/application-confirmation.blade.php ENDPATH**/ ?>