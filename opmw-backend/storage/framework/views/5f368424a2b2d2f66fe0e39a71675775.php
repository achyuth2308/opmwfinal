...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <a href="<?php echo e(env('FRONTEND_URL')); ?>/portal" class="cta">Access Your Portal →</a>
        </div>
        <div class="footer">
            <p>© <?php echo e(date('Y')); ?> OPMW — One Platform Multiple Work. All rights reserved.</p>
            <p style="margin-top:4px;">Tidel Park, Taramani, Chennai – 600113</p>
        </div>
    </div>
</body>

</html><?php /**PATH D:\OPMW_One Place Multi Work\opmwfinal\opmw-backend\resources\views/emails/welcome.blade.php ENDPATH**/ ?>